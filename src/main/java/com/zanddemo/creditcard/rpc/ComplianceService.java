...
public class ComplianceService {
	...
	public boolean submitRequest(CreditCardApplicationBasicInfo creditCardApplicationBasicInfo) {
		...
		log.info("Submitting for Compliance Check {} {}", creditCardApplicationBasicInfo.getEmiratesId(), creditCardApplicationBasicInfo.getIdempotentId());
		Boolean result = (Boolean)redisTemplate.opsForHash().get(CC_DEMO_RPC_MOCK, COMPLIANCE_SB);
