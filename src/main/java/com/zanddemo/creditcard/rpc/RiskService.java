...
public class RiskService {
	...
	public boolean submitRequest(CreditCardApplicationBasicInfo creditCardApplicationBasicInfo) {
		...
		log.info("Submitting for Risk Evaluation {} {}", creditCardApplicationBasicInfo.getEmiratesId(), creditCardApplicationBasicInfo.getIdempotentId());
		Boolean result = (Boolean)redisTemplate.opsForHash().get(CC_DEMO_RPC_MOCK, RISK_SB);
